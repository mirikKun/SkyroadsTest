...
namespace Code.Gameplay.LevelGenerator.Factories
{
    public class LevelFactory : ILevelFactory
    {
        ...
        public LevelFactory(IStaticDataService staticDataService, IPlayerMoverSystem playerMoverSystem,
            IPassedObstaclesCounterSystem passedObstaclesCounterSystem)
        {
