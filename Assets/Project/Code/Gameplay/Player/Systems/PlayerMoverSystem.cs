...
namespace Code.Gameplay.Player.Systems
{
    public class PlayerMoverSystem : IPlayerMoverSystem
    {
        ...
        public PlayerMoverSystem(IInputService inputService, IStaticDataService staticDataService,
        ...
        private void MovePlayer()
        {
            ...
            Vector3 velocity = new Vector3(_horizontalInput * _movementConfig.SideSpeed * speedMultiplier, 0,
                _movementConfig.ForwardSpeed * speedMultiplier);
